This is a demo application showing my ability to write code in JavaScript. It pretends to be production-ready, 
but it does not implements any sophisticated features.
...
# Limitations and possible ways to improve
- example data hardcoded and only pretends to be a real request
- zero test coverage
- deployed to heroku
- default design from bootstrap 


# DEFAULT README BY CREATE REACT APP IS DOWN BELOW
